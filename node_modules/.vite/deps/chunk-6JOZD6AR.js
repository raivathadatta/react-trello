...
var OutlinedInput = React74.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime52.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime52.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime51.jsxs)(React74.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var Popover = React81.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime59.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
  ...
  return (0, import_jsx_runtime64.jsxs)(React84.Fragment, {
    children: [(0, import_jsx_runtime63.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span7 || (_span7 = (0, import_jsx_runtime63.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
...
var Select3 = React86.forwardRef(function Select4(inProps, ref) {
  ...
  return (0, import_jsx_runtime66.jsx)(React86.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6JOZD6AR.js.map

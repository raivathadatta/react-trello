...
var OutlinedInput = React72.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime51.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime51.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime50.jsxs)(React72.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2WONDXEE.js.map
